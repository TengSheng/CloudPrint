	...
	<div id="output">
		<div class="containerT">
			...
			<form action="${pageContext.request.contextPath}/user/login.do" id="entry_form" method="post">
				<input type="text" placeholder="用户名" id="entry_name" name="userName" value="${user.userName}">
				<input type="password" placeholder="密码" id="entry_password" name="password" value="${user.password}">
